    ...
    <div class="ui-view w3-bar w3-light-grey">
        ...
        <div class="w3-dropdown-click">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                <a href="#" class="w3-bar-item w3-button" data-mid="msgModal" >message modal</a>
                <a href="#" class="w3-bar-item w3-button" data-mid="progressModal" >progress modal</a>
                <a href="#" class="w3-bar-item w3-button" data-mid="waitModal" >wait modal</a>
            </div>
        </div>
    </div>
    `;
